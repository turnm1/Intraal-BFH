 ...
 * @author turna
 */
public class StartEingangModul implements Runnable {
    ...
    AmbientLightSensor als = new AmbientLightSensor(tinkerforgeIP2, cp.getTINKERFORGE_SENSOR_UID_EINGANG_AMBIENTELIGHT(), room);
